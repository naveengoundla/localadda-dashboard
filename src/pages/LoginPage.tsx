...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: { background: '#fff', borderRadius: 24, padding: '40px 32px', width: '100%', maxWidth: 420, boxShadow: '0 24px 80px rgba(0,0,0,0.3)', boxSizing: 'border-box' },
  ...
  otpBox: { width: 44, minWidth: 0, border: '1.5px solid #e8e8e8', borderRadius: 10, textAlign: 'center', fontSize: 22, fontWeight: 800, padding: '12px 0', outline: 'none' },
